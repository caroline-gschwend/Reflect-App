 ...
 */
public class MoodEntryProvider extends ContentProvider {

    public static final String TAG = MoodEntryProvider.class.getName();
    ...
    public boolean onCreate() {
        moodEntryItemDao = MoodEntryItemDatabase.getInstance(getContext()).getToDoItemDao();
        return false;
    }
